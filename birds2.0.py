...
def plot_values(txt_file, startDate, timeSpan, interval):
    """
...
def get_user_selection():
    ...
    timespan = int(input("How many days do you want to display? "))
...
start_date, timespan, interval = get_user_selection()
plot_values("bird_data.txt", start_date, timespan, interval)
